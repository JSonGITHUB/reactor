...
const Garden = () => {
    ...
    useEffect(() => {
        if (crops) {
            console.log(`Garden => crops: ${JSON.stringify(crops.map((crop) => crop.name), null, 2)}`);
    ...
    return (
        <div className='mt--30'>
            <div className='containerDetail color-lite bg-green m-5 p-22 size30 contentLeft'>
            ...
            <div className='containerDetail space-y-2 bg-lite m-5'>
