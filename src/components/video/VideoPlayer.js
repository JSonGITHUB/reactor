...
const VideoPlayer = React.forwardRef((props, ref) => {
  ...
  }, [playerStatus.videoRef, playerStatus.endTime]);
    ...
    <div>
      ...
      <div className='containerBox flexContainer centerVertical '>
        <div className='containerBox'>
          ...
          <span className='flex1Auto'>
            {playerStatus.endTime}
          </span>
        </div>
        <div 
          className='flex1Auto button contentRight p-10' 
        ...
        />
        <div 
          className='button flex1Auto contentRight p-10' 
