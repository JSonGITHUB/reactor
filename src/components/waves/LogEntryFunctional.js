...
const LogEntry = ({ logId, onChange, getStateLog, title, message, items }) => {
    ...
    const groups = () => items.map((item) => {
        ...
        return <div key={getKey(`groupConainer${description}`)} className='containerBox bg-lite'>
    ...
    const dateEntry = () => {
        ...
        return <div className='containerBox bg-lite'>
        ...
        (!status.log.Comments)
            ...
            : <Route>
                <form onSubmit={()=>console.log(`Session/LogEntryFunctional => submit: logId: ${logId} `)}>
                    ...
                    <div className='containerBox color-yellow bold bg-tintedMedium'>
