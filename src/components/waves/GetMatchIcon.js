...
const getMatchIcon = ({kind, status}) => {
    ...
    const getStarMatchKind = (kind) => {
        ...
        let classes = `h50w50 pl-5 pr-5 ${(kind === 'tide') ? 'pb-5' : 'pt-5'}`;
    ...
    if (kind === "swell1") {
        ...
        return <div className='mt--5'>
                    ...
                    <div className='flex2Column contentCenter bg-white mt-10 r-10 width50px'>
        ...
        return <div className='flex2Column contentCenter'>
                    <div className='bold mt-20 mb-25 pb-1'>WIND</div>
                    <div className='bg-white r-10 width50px m-auto'>{getDirectionIcon(windDirection)}</div>
                </div>
