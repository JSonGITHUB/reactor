...
const Sunset = ({isMotionOn}) => {
    ...
    useEffect(() => {
        if (data.results !== undefined) {
            ...
            const sunsetDisplayTime = `${(sunsetHours>12)?(sunsetHours-12):sunsetHours}:${sunsetMinutes}`
    ...
    const getCurrentSunset = () => <React.Fragment>
        <div className="p-10 r-10 bg-tinted m-5">
            <div className="p-10 r-10 color-yellow bg-tinted bold">surf time remaining:</div>
            <div className="r-10 white p-10">
                {surfTime()}
            </div>
        </div>
        <div className="flexContainer">
            <div className="flex3Column r-10 color-lite bg-tinted m-5">
                <div className="color-yellow bold bg-tinted p-10 r-10 m-10 size20">SUNRISE</div>
                <div className="p-10 white">
                    {sunrise}
                    <span className='copyright bold'>
                        AM
                    </span>
                </div>
            </div>
            <div className="flex3Column r-10 color-lite bg-tinted m-5">
                <div className="color-yellow bold bg-tinted p-10 r-10 m-10 size20">SUNSET</div>
                <div className="p-10 white">
                    {sunset}
                    <span className='copyright bold'>
                        PM
            ...
            <div className="flex3Column r-10 color-lite bg-tinted m-5">
                <div className="color-yellow bold bg-tinted p-10 r-10 m-10 size20">DARK</div>
