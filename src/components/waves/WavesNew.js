            ...
            <div className='containerDetail bg-lite mt--25'>
                ...
                </div>
                {
                    ...
                    ? <div>
                        ...
                        <div className='containerDetail size20 p-20 mt-5 mb-5 button color-red brdr-red' onClick={handleSwellLiveSelection}>
                ...
                <div className='containerDetail mt-5 mb-5 size20 color-yellow bg-lite p-20'>
                    <CollapseToggleButton
                        title={
                            `${
                                (locationCollapse)
                ...
                <div className='containerDetail size20'></div>
                <div className='mb--10'>
