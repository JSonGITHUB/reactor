...
const DebtCollector = () => {
    ...
    return (
        <div className='containerBox'>
            <div className='containerDetail p-20 bg-yellow color-dark bold contentLeft size25'>
            ...
            <div className='containerBox bg-lite'>
                <div>
                    ...
                    <div title='add debt' onClick={(collection === 'debt') ? addDebt : addDues} className='containerDetail p-10 button bg-white button w-200 ml-auto mr-auto mb-10 mt-10'>
                        ➕
                    </div>
                </div>
            </div>
