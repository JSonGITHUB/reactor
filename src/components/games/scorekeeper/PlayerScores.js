...
const PlayerScores = () => {
   ...
   useEffect(() => {
    ...
    const newHeatTimer = () => {
        ...
        //setTimerOn(false);
        console.log(`PlayerScores => newHeatTimer  => heatLength: ${heatLength}`);
        console.log(`PlayerScores => newHeatTimer  => time: ${time}`);
    }
    ...
    const displayHeatLog = () => {
        ...
        return <div className='containerDetail m-5 bg-lite'>
            <div className='containerBox size15 mt-5 mb--5 color-yellow'>
            ...
            {(heatsCollapse) ? <div></div> : <div className='scrollMaxHeight400'>{log()}</div>}
        </div>
    }
    ...
    */
    ...
    const scorecards = () => {
        ...
        const dominoClass = (playerIndex) => 'color-yellow flex2Column p-20 size25 bold' + ((isDominoWinner(playerIndex)) ? ' color-neogreen shakingShaka mt-20' : '');
    ...
    return <div className='fadeIn mt--30'>
        ...
        <div>
            ...
            <div className='bg-stealthLite'>
                <div className={`containerDetail m-5 scrollHeight550 ${(priorityCollapse) ? 'sticky180' : 'sticky260'} bg-lite`}>
                    ...
                    {/*}
                    <div className='mt--10 t-0 absolute width-100-percent contentCenter'>
                        <NumberInputKeypad
                            onEnter={setSurfScores}
                            currentScoreIndex={currentScoreIndex}
                            playerId={playerId}
                    ...
                    */}
                    {
                        (isCurrentGame('surf'))
                            ? <div className='containerDetail ml-5 mb-10 mt-5 mr--5 p-10 size20 color-yellow'>
                                <CollapseToggleButton
                    ...
                    }
                    {
                        (scoresCollapse && isCurrentGame('surf'))
                            ...
                            : (isCurrentGame('surf'))
                                ? scorecards()
                                : <div>
                                    <div className='containerBox size15 color-yellow'>
                                        <CollapseToggleButton
                                            title={'Current Game'}
        ...
        <div className={`containerDetail bg-lite m-5`}>
            <div className={`containerBox color-yellow size15 mt-5 mb--5 ${(game === 'surf')?'pr-20':'' }`}>
                <CollapseToggleButton
