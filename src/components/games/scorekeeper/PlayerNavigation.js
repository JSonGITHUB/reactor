  ...
  return (
    <div>
      ...
      <div>
        ...
        <button title='Play/Pause' onClick={handlePlayPause}>Play/Pause</button>
        <button title='Slow Motion' onClick={handleSlowMotion}>Slow Motion</button>
        <button title='Slow Rewind' onClick={handleSlowRewind}>Slow Rewind</button>
        <button title='Jump to Start Keyframe' onClick={handleJumpToStart}>Jump to Start Keyframe</button>
        <button title='Jump to End Keyframe' onClick={handleJumpToEnd}>Jump to End Keyframe</button>
        <input 
          id='currentTime'
          name='currentTime'
          type='range' 
