...
const Notes = () => {
    ...
    const [tracking, setTracking] = useState('notes');
    ...
    const getIngredients = () => {
        ...
        //console.log(`Notes => ingredients sorted: ${JSON.stringify(sorted, null, 2)}`);
    ...
    useEffect(() => {
        ...
        //console.log(`Notes =>  notes: ${JSON.stringify(notes, null, 2)}`)
        //setTracking('recipes')
    ...
    useEffect(() => {
        //console.log(`Notes => links: ${JSON.stringify(links, null, 2)}`);
    ...
    useEffect(() => {
        if (tasks !== undefined || tasks !== '') {
            console.log(`Notes => tasks: ${JSON.stringify(tasks, null, 2)}`);
    ...
    useEffect(() => {
        if (newProjectDescription !== undefined) {
            ...
            if (tracking === 'recipes' && recipes !== undefined) {
                ...
                console.log(`Notes => searchTerm: '${searchTerm}'`);
                ...
                const inTaskGoupDescription = (taskGroup) => {
                    ...
                    console.log(`Notes => inTaskGoupDescription => task.description: ${taskGroup.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                const inTaskDescription = (task) => {
                    const result = task.description.toLowerCase().includes(searchTerm);
                    console.log(`Notes => inTaskDescription => task.description: ${task.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                filteredTasks.map((taskGroup) => {
                    ...
                    taskGroup.tasks.map((task) => {
                        if ((inTaskGoupDescription(taskGroup) || inTaskDescription(task) || inTaskSessionDescription(task) || searchTerm === '' || searchTerm === ' ' || searchTerm === null) && (category === 'all' || taskGroup.category === category)) {
                            ...
                            console.log(`Notes => category: ${category} searchTerm: '${searchTerm}' true`);
                            console.log(`Notes taskGroup: ${JSON.stringify(taskGroup, null, 2)}`);
                        }
                    });
                });
                ...
                const inChargeDescription = (charge) => {
                    ...
                    console.log(`Notes => inChargeDescription => charge.description: ${charge.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                const inLinkDescription = (link) => {
                    ...
                    console.log(`Notes => inLinkDescription => link.description: ${link.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
