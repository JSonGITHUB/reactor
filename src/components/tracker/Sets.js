...
const Sets = () => {
    ...
    const getIngredients = () => {
        ...
        //console.log(`Sets => ingredients sorted: ${JSON.stringify(sorted, null, 2)}`);
    ...
    useEffect(() => {
        ...
        //console.log(`Sets =>  notes: ${JSON.stringify(notes, null, 2)}`)
        //setTracking('recipes')
    ...
    useEffect(() => {
        //console.log(`Sets => links: ${JSON.stringify(links, null, 2)}`);
    ...
    useEffect(() => {
        if (tasks !== undefined || tasks !== '') {
            console.log(`Sets => tasks: ${JSON.stringify(tasks, null, 2)}`);
    ...
    useEffect(() => {
        if (newProjectDescription !== undefined) {
            ...
            if (tracking === 'recipes' && recipes !== undefined) {
                ...
                console.log(`Sets => searchTerm: '${searchTerm}'`);
                ...
                const inTaskGoupDescription = (taskGroup) => {
                    ...
                    console.log(`Sets => inTaskGoupDescription => task.description: ${taskGroup.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                const inTaskDescription = (task) => {
                    const result = task.description.toLowerCase().includes(searchTerm);
                    console.log(`Sets => inTaskDescription => task.description: ${task.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                filteredTasks.map((taskGroup) => {
                    ...
                    taskGroup.tasks.map((task) => {
                        if ((inTaskGoupDescription(taskGroup) || inTaskDescription(task) || inTaskSessionDescription(task) || searchTerm === '' || searchTerm === ' ' || searchTerm === null) && (category === 'all' || taskGroup.category === category)) {
                            ...
                            console.log(`Sets => category: ${category} searchTerm: '${searchTerm}' true`);
                            console.log(`Sets taskGroup: ${JSON.stringify(taskGroup, null, 2)}`);
                        }
                    });
                });
                ...
                const inChargeDescription = (charge) => {
                    ...
                    console.log(`Sets => inChargeDescription => charge.description: ${charge.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                const inLinkDescription = (link) => {
                    ...
                    console.log(`Sets => inLinkDescription => link.description: ${link.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
