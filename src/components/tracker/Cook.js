...
const Cook = () => {
    ...
    const getIngredients = () => {
        ...
        //console.log(`Cook => ingredients sorted: ${JSON.stringify(sorted, null, 2)}`);
    ...
    useEffect(() => {
        ...
        //console.log(`Cook =>  notes: ${JSON.stringify(notes, null, 2)}`)
        //setTracking('recipes')
    ...
    useEffect(() => {
        //console.log(`Cook => links: ${JSON.stringify(links, null, 2)}`);
    ...
    useEffect(() => {
        if (tasks !== undefined || tasks !== '') {
            console.log(`Cook => tasks: ${JSON.stringify(tasks, null, 2)}`);
        ...
        if (newProjectDescription !== undefined) {
            ...
            if (tracking === 'recipes' && recipes !== undefined) {
                ...
                const inTaskGoupDescription = (taskGroup) => {
                    ...
                    console.log(`Cook => inTaskGoupDescription => task.description: ${taskGroup.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                const inTaskDescription = (task) => {
                    const result = task.description.toLowerCase().includes(searchTerm);
                    console.log(`Cook => inTaskDescription => task.description: ${task.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                filteredTasks.map((taskGroup) => {
                    ...
                    taskGroup.tasks.map((task) => {
                        if ((inTaskGoupDescription(taskGroup) || inTaskDescription(task) || inTaskSessionDescription(task) || searchTerm === '' || searchTerm === ' ' || searchTerm === null) && (category === 'all' || taskGroup.category === category)) {
                            ...
                            console.log(`Cook => category: ${category} searchTerm: '${searchTerm}' true`);
                            console.log(`Cook taskGroup: ${JSON.stringify(taskGroup, null, 2)}`);
                        }
                    });
                });
                ...
                const inChargeDescription = (charge) => {
                    ...
                    console.log(`Cook => inChargeDescription => charge.description: ${charge.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                const inLinkDescription = (link) => {
                    ...
                    console.log(`Cook => inLinkDescription => link.description: ${link.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
