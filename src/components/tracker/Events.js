...
const Events = () => {
    ...
    const [tracking, setTracking] = useState('events');
    ...
    const getIngredients = () => {
        ...
        //console.log(`Events => ingredients sorted: ${JSON.stringify(sorted, null, 2)}`);
    ...
    useEffect(() => {
        ...
        //console.log(`Events =>  notes: ${JSON.stringify(notes, null, 2)}`)
        //setTracking('recipes')
    ...
    useEffect(() => {
        //console.log(`Events => links: ${JSON.stringify(links, null, 2)}`);
    ...
    useEffect(() => {
        if (tasks !== undefined || tasks !== '') {
            console.log(`Events => tasks: ${JSON.stringify(tasks, null, 2)}`);
        ...
        if (newProjectDescription !== undefined) {
            ...
            if (tracking === 'recipes' && recipes !== undefined) {
                ...
                const inTaskGoupDescription = (taskGroup) => {
                    ...
                    console.log(`Events => inTaskGoupDescription => task.description: ${taskGroup.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                const inTaskDescription = (task) => {
                    const result = task.description.toLowerCase().includes(searchTerm);
                    console.log(`Events => inTaskDescription => task.description: ${task.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                filteredTasks.map((taskGroup) => {
                    ...
                    taskGroup.tasks.map((task) => {
                        if ((inTaskGoupDescription(taskGroup) || inTaskDescription(task) || inTaskSessionDescription(task) || searchTerm === '' || searchTerm === ' ' || searchTerm === null) && (category === 'all' || taskGroup.category === category)) {
                            ...
                            console.log(`Events => category: ${category} searchTerm: '${searchTerm}' true`);
                            console.log(`Events taskGroup: ${JSON.stringify(taskGroup, null, 2)}`);
                        }
                    });
                });
                ...
                const inChargeDescription = (charge) => {
                    ...
                    console.log(`Events => inChargeDescription => charge.description: ${charge.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
                ...
                const inLinkDescription = (link) => {
                    ...
                    console.log(`Events => inLinkDescription => link.description: ${link.description} searchTerm: ${searchTerm} result: ${result}`);
                    return result;
                }
